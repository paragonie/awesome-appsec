...
# Application Security Learning Resources
  ...
  * [General](#general)
    * [Articles](#articles)
      ...
      * [CVE-2023-36884: Microsoft Office Zero Day RCE](#cve-2023-36884-microsoft-office-zero-day-rce-2023) (2023)
      * [Account Takeover vulnerability in ChatGPT](#account-takeover-vulnerability-in-chatgpt)
      * [Thick Client Penetration Testing: Uncovering Vulnerabilities in Desktop Applications](#thick-client-penetration-testing-uncovering-vulnerabilities-in-desktop-applications)
    * [Books](#books)
    ...
    * [Websites](#websites)
      ...
      * [Tools](#tools)
        ...
        * [JWack](#jwack)
  * [AWS](#aws)
    * [AWS Penetration Testing](#-aws-penetration-testing) ![nonfree](img/nonfree.png)
  ...
  * [C](#c)
    * [Books and ebooks](#books-and-ebooks-1)
      ...
      * [Defensive Coding: A Guide to Improving Software Security by the Fedora Security Team](#defensive-coding-a-guide-to-improving-software-security-by-the-fedora-security-team-2024) (2024)
  * [C++](#c-1)
  ...
  * [Windows](#windows)
    * [Training](#training-3)
      * [Widnows Thick Client Penetration Testing.](#-widnows-thick-client-penetration-testing) ![nonfree](img/nonfree.png)
...
### [CVE-2023-36884: Microsoft Office Zero Day RCE](https://www.darkrelay.com/post/cve-2023-36884-office-zero-day-rce) (2023)

**Released**: August 12, 2023

A zero-day vulnerability with the identifier CVE-2023-36884 surfaced, posing a severe threat to Microsoft Windows and Office products. Cyber attackers have already initiated targeted attacks against government and defense organizations in Europe and North America, making it a matter of utmost concern for the security community.

### [Account Takeover vulnerability in ChatGPT](https://example.com)

A severe security vulnerability discovered in ChatGPT that allowed an attacker to take over any user's account with a single click, giving them access to sensitive information and the ability to perform unauthorized actions.
...
### ![nonfree](img/nonfree.png) [Buffer Overflow exploitation](https://www.darkrelay.com/challenge-page/bufferoverflow?programId=6d1626da-1717-474f-b05c-d88cc09489c4)
...
### [Certified AppSec Pentester (CAPen) - secops](https://secops.group/product/certified-appsec-pentester/)
...
#### [JWack](https://github.com/offen5iv3/JWack)

JWack is a powerful security tool designed for interacting with JSON Web Tokens (JWT).

# AWS

## ![nonfree](img/nonfree.png) [AWS Penetration Testing](https://www.darkrelay.com/challenge-page/awspentest?programId=6fd8fcb3-ae72-4c07-912e-bffa49b13e20)

An AWS penetration testing online course and program will teach you the skills and knowledge you need to conduct penetration tests on AWS environments. This includes learning about the AWS infrastructure, the different types of AWS services, and the common security vulnerabilities associated with AWS.
...
### ![nonfree](img/nonfree.png) [Mastering Android Application Penetration Testing (MAPT)](https://www.darkrelay.com/challenge-page/android-application-penetration-testing?programId=0a27eec7-197a-4efe-8032-955980e7a85c)

Dive deep into Android security through this expansive training program to equip you with critical skills for defending Android applications from sophisticated cyber threats. Learn the latest techniques and tools to uncover vulnerabilities, exploit security gaps, and safeguard sensitive data.

### ![nonfree](img/nonfree.png) [Advanced Mobile Application Security (AMAS)](https://www.darkrelay.com/challenge-page/advanced-mobile-application-security?programId=d8334ef1-d926-4f9c-bdbd-bcf16c50d6b9)

Master mobile app security with this hands-on course focusing on Android and iOS platforms. Learn to identify, exploit, and mitigate vulnerabilities through reverse engineering, runtime manipulation, and secure coding practices. Designed for cybersecurity professionals, developers, and pentesters, this course equips you to perform comprehensive security assessments and defend against advanced mobile threats.

### [Mobile Application Penetration Testing - TCM security](https://academy.tcm-sec.com/p/mobile-application-penetration-testing)
...
### ![nonfree](img/nonfree.png) [Widnows Thick Client Penetration Testing.](https://www.darkrelay.com/challenge-page/thick-client-penetration-testing?programId=4815786f-f9ab-40b0-9a18-35197e4d3843)

Thick Client Penetration Testing (TPT) course to understand the methodologies, tools, and techniques required for assessing the security of Windows thick client applications.
